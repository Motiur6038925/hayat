...
const QuillScript = dynamic(() => import("@/utility/QuillScript"), {
  ssr: false,
});
const BlogUpdateDialog = dynamic(
  () => import("@/components/BlogUpdateDialog"),
  {
    ssr: false,
  }
);
const DeleteAlertBlogPost = dynamic(() => import("@/utility/DeleteAlert"), {
  ssr: false,
});
